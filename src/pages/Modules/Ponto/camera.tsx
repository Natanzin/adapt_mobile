        ...
        <View style={styles.container}>
            ...
            >
                <View style={styles.buttonContainer}>
                    <View style={styles.marcacaoRosto} />
                    <Text children='Centralize o rosto na área demarcada!' style={styles.text} />
                </View>
            </Camera>
